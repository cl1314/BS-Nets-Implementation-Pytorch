...
BANDLIST =  [ 68, 182 , 73 ,111 , 63, 149, 106 ,116 , 58, 144]
...
img_channels = 10  #For Band Selection purposes
...
for index_iter in range(ITER):
    ...
    best_weights_RES_path_ss4 = 'models/Indian_10_' + str(
        index_iter + 1) + '.hdf5'
...
modelStatsRecord.outputStats(KAPPA_RES_SS4, OA_RES_SS4, AA_RES_SS4, ELEMENT_ACC_RES_SS4,
                             ...
                             'records/IN_sd-10.txt',
                             'records/IN_sd_element-10.txt')
