...
img_channels = 25  #For Band Selection purposes
...
for index_iter in range(ITER):
    ...
    best_weights_RES_path_ss4 = 'models/Indian_25_' + str(
        index_iter + 1) + '.hdf5'
...
modelStatsRecord.outputStats(KAPPA_RES_SS4, OA_RES_SS4, AA_RES_SS4, ELEMENT_ACC_RES_SS4,
                             ...
                             'records/IN_sd-25.txt',
                             'records/IN_sd_element-25.txt')
